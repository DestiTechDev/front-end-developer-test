...
const travels = [
    {
      ...
      thumb: image1,
      title: "Salvador - BA",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna tellus, tristique in mi non, volutpat molestie nibh.",
      tags: ["Cras urna dui", "Scelerisque aliquam felis in", "Aliquet efficitur neque", "Proin eget rutrum mi", "Donec tincidunt nunc nec lorem efficitur iaculi"],
      country: "Brasil",
      price: "800,00",
    },
    {
      ...
      description: "Sed condimentum justo enim, ut feugiat arcu aliquet id. Praesent auctor leo porta, tempus lacus sed, euismod elit. Ut tristique mollis massa et mattis.",
      tags: ["Cras urna dui", "Scelerisque aliquam felis in", "Aliquet efficitur neque", "Proin eget rutrum mi", "Donec tincidunt nunc nec lorem efficitur iaculi"],
      country: "Brasil",
      price: "640,00",
    },
    {
      ...
      thumb: image3,
      title: "São Paulo - SP",
      description: "Etiam molestie scelerisque odio, in ultrices metus venenatis a. Phasellus accumsan, nisl ut vulputate consectetur, sapien metus luctus enim, sed interdum nulla est vitae risus.",
      tags: ["Cras urna dui", "Scelerisque aliquam felis in", "Aliquet efficitur neque", "Proin eget rutrum mi", "Donec tincidunt nunc nec lorem efficitur iaculi"],
      country: "Brasil",
      price: "240,00",
    },
...
const Carousel: React.FC = () => {
  ...
  return (
    ...
    <div className="flex items-center">
      ...
      <button onClick={next} className={`${currentSlide === travels.length - 1? 'invisible': 'visible'} px-4 py-2`}>
      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 ">
          <svg
            className="w-[20px] h-[20px] text-black "
            aria-hidden="true"
